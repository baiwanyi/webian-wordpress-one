...
class WWPO_Wechat_Errcode
{
     ...
     * @Author:helen zheng
     */
    static function display($code)
    {
        switch ($code) {
            case -1: return '系统繁忙，请稍候再试';
            case 0: return '请求成功';
            /** 全局返回码说明 */
            case 40001: return '获取 access_token 时 AppSecret 错误，或者 access_token 无效';
            ...
            case 42001: return 'access_token 超时，请检查 access_token 的有效期';
            ...
            /** 客服管理接口返回码说明 */
            case 65400: return 'API不可用，即没有开通/升级到新版客服功能';
            case 65401: return '无效客服帐号';
            case 65403: return '客服昵称不合法';
            case 65404: return '客服帐号不合法';
            case 65405: return '帐号数目已达到上限，不能继续添加';
            case 65406: return '已经存在的客服帐号';
            case 65407: return '邀请对象已经是该公众号客服';
            case 65408: return '本公众号已经有一个邀请给该微信';
            case 65409: return '无效的微信号';
            case 65410: return '邀请对象绑定公众号客服数达到上限（目前每个微信号可以绑定5个公众号客服帐号）';
            case 65411: return '该帐号已经有一个等待确认的邀请，不能重复邀请';
            case 65412: return '该帐号已经绑定微信号，不能进行邀请';
            /** 评论管理接口返回码说明 */
            case 88000: return '没有留言权限';
            case 88001: return '该图文不存在';
            case 88002: return '文章存在敏感信息';
            case 88003: return '精选评论数已达上限';
            case 88004: return '已被用户删除，无法精选';
            case 88005: return '已经回复过了';
            case 88007: return '回复超过长度限制或为 0';
            case 88008: return '该评论不存在';
            case 88009: return '该回复不存在';
            case 88010: return '获取评论数目不合法 ';
