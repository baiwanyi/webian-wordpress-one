...
$option_data  = get_option(WWPO_Wechat::KEY_OPTION);
$wechat_form  = [
    'submit'    => 'updatewechat',
    ...
    'formdata'  => [
        ...
        'wechat_url'    => [
            'title' => '微信服务器连接地址',
            'field' => ['type' => 'text', 'value' => home_url('wp-json/wwpo/wechat/connect'), 'disabled' => true],
            'after' => '<div data-action="copy" data-target="#wechat_url">复制</div>'
        ],
        'accesstoken'    => [
